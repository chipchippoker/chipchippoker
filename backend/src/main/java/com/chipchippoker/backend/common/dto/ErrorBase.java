...
public enum ErrorBase {
	...
	E403_FORBIDDEN_ALREADY_IN_GAME_ROOM(FORBIDDEN, false, "FB010", "이미 방에 입장한 상태입니다."),
	E403_FORBIDDEN_ALREADY_IN_SPECTATE_ROOM(FORBIDDEN, false, "FB011", "이미 관전방에 입장한 상태입니다."),
