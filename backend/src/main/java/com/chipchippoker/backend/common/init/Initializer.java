...
public class Initializer implements ApplicationRunner {
	...
	public void run(ApplicationArguments args) throws NoSuchAlgorithmException {
		...
		String[] names = {"최현기", "권순준", "임세환", "선수연", "윤예빈", "김대원", "싸피1", "대원이", "김현기", "김지수", "윤동희", "권희주", "선주리",
			"임주호", "윤희서", "김명주", "김희주", "싸피2", "싸피3", "싸피4", "서울4반", "서울5반", "서울8반", "인천", "대구", "대전", "부산", "울산", "김김",
			"님님", "딤딤", "림림"};
		String[] nicknames = {"최현기", "권순준", "임세환", "선수연", "윤예빈", "김대원", "싸피1", "대원이", "김현기", "김지수", "윤동희", "권희주", "선주리",
			"임주호", "윤희서", "김명주", "김희주", "싸피2", "싸피3", "싸피4", "서울4반", "서울5반", "서울8반", "인천", "대구", "대전", "부산", "울산", "김김",
			"님님", "딤딤", "림림"};
