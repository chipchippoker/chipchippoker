...
public class ProfilePageResponse {
	...
	public static ProfilePageResponse createProfilePageResponse(String icon, Integer rank, Integer rankFriend, Integer win, Integer draw, Integer lose,
		Integer maxWin, Integer point, String nickname, String tier, Boolean isMine,
		List<RecentPlayListResponse> recentPlayList){
