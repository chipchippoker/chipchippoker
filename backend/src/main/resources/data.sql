...
VALUES (4, 5, 12, 8, 7, 11, 20, 8, 1670, NOW(), 1, NOW()),
       (3, 4, 8, 5, 4, 8, 26, 6, 2000, NOW(), 2, NOW()),
       (5, 3, 15, 5, 3, 1, 32, 7, 2320, NOW(), 3, NOW()),
       (7, 0, 8, 6, 2, 21, 40, 6, 1820, NOW(), 4, NOW()),
       (8, 1, 20, 5, 1, 10, 50, 12, 1967, NOW(), 5, NOW()),
       (10, 6, 11, 5, 0, 10, 10, 10, 2600, NOW(), 6, NOW()),
       (5, 2, 9, 5, 0, 11, 8, 5, 1350, NOW(), 7, NOW()),
       (5, 2, 8, 5, 0, 11, 8, 6, 1000, NOW(), 8, NOW()),
       (5, 2, 8, 5, 7, 11, 8, 6, 1200, NOW(), 9, NOW()),
       (5, 2, 8, 5, 7, 11, 8, 6, 1392, NOW(), 10, NOW()),
       (5, 2, 8, 5, 7, 11, 8, 6, 1500, NOW(), 11, NOW()),
       (5, 2, 8, 5, 7, 11, 8, 6, 760, NOW(), 12, NOW()),
       (5, 2, 8, 5, 7, 11, 8, 6, 760, NOW(), 13, NOW()),
       ...
       (5, 2, 8, 5, 7, 11, 20, 6, 800, NOW(), 38, NOW()),
       (5, 2, 8, 5, 7, 11, 20, 6, 800, NOW(), 39, NOW()),
       (5, 2, 8, 5, 7, 11, 20, 6, 800, NOW(), 40, NOW()),
       (5, 2, 8, 5, 7, 11, 20, 6, 1200, NOW(), 41, NOW()),
       (5, 2, 8, 5, 7, 11, 20, 6, 1200, NOW(), 42, NOW()),
       (5, 2, 8, 5, 7, 11, 20, 6, 1200, NOW(), 43, NOW()),
       (5, 2, 8, 5, 7, 11, 20, 6, 1200, NOW(), 44, NOW()),
       (5, 2, 8, 5, 7, 11, 20, 6, 1200, NOW(), 45, NOW()),
       (5, 2, 8, 5, 7, 11, 20, 6, 1200, NOW(), 46, NOW()),
       (5, 2, 8, 5, 7, 11, 20, 6, 1200, NOW(), 47, NOW()),
       (5, 2, 8, 5, 7, 11, 20, 6, 1200, NOW(), 48, NOW()),
       (5, 2, 8, 5, 7, 11, 20, 6, 1200, NOW(), 49, NOW()),
       (5, 2, 8, 5, 7, 11, 20, 6, 1200, NOW(), 50, NOW()),
       (5, 2, 8, 5, 7, 11, 20, 6, 1200, NOW(), 51, NOW()),
       (5, 2, 8, 5, 7, 11, 20, 6, 1200, NOW(), 52, NOW());
