...
// OpenVidu objects
export const OV = ref(undefined)
export const session = ref(undefined)
export let mainStreamManager = ref(undefined)
export const publisher = ref(undefined)
export const subscribers = ref([])

export const roomId = ref('')
const roomTitle = ref('')
const totalParticipantCnt = ref('')
export const myNickname = ref('')
